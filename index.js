...
//-- Group Metadata
     ...
     const isBot = mek.key.fromMe ? false : false
...
*≡ OWNER*
▢ Instagram : https://www.instagram.com/mmppppss
▢ WhatsApp : wa.me/


` 
Fg.send2Button(from, teks, '*:D*', `ꨄ︎ Apoyar`, `${prefix}donate`, `⌬ ${msg.gp}s`, `${prefix}grupos`)
   break
...
Fg.send2ButtonLoc(from, welm, capt, 'Sígueme en Instagram\nhttps://www.instagram.com/mmppppss', '⦙☰ MENU', '/menu', '⏍ INFO GP', '/infogp', false, {
	      contextInfo: { 
            mentionedJid: Fg.parseMention(capt)
	      } 
	    }); //--
